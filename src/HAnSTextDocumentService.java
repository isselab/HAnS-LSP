...
public class HAnSTextDocumentService implements TextDocumentService {
    ...
    public HAnSTextDocumentService(HAnSLanguageServer x) {
    ...
    public CompletableFuture<Either<List<CompletionItem>, CompletionList>> completion(CompletionParams completionParams) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                completionItem1.setInsertText("//&Begin[]\n//&End[]\n}");
                completionItem1.setLabel("&Begin[]");
                completionItem1.setKind(CompletionItemKind.Snippet);
                completionItem1.setDetail("Creating a new block for feature");
